                ...
                <div class="portlet-body">
                    ...
                    <form method="POST" action="{{ route('sub-admin.store') }}" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input required type="text" name="first_name" maxlength="150" value="{{ old('first_name') }}"
                                       class="form-control"/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input required type="text" name="email" maxlength="32" value="{{ old('email') }}"
                                       class="form-control"/>
                            </div>
                            @if ($errors->has('email'))
                                <span class="help-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input required type="text" name="phone" maxlength="32" value="{{ old('phone') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select class="form-control col-md-7 col-xs-12 role-type select2" name="role" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input required type="password" name="password" maxlength="32" value=""
                                       class="form-control"/>
                            </div>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-4">
                                ...
                                <img id="image" style="max-width: 350px;height: 150px; margin-top: 16px" onClick="preview(this);"  src="" />

...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('studio.type.edit',$type) }}
        ...
        <!-- BEGIN SAMPLE FORM PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <form method="POST"
                          action="{{ route('studio.type.update',$type->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input type="text" name="type_name" maxlength="150" value="{{ old('type_name',$type->name) }}"
                                       class="form-control"/>
                            </div>

                ...
                <div class="portlet-body">
                    ...
                    <form method="POST"
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="audio_eng_included_yes" name="audio_eng_included"
                                           ...
                                           value="1" {{ (old('audio_eng_included',$studio->audio_eng_included) == '1') ? 'checked' : '' }}/>
                                    ...
                                    <input type="radio" id="audio_eng_included_no" name="audio_eng_included"
                                           class="form-check-input"
                                           value="0" {{ (old('audio_eng_included',$studio->audio_eng_included) == '0') ? 'checked' : ''  }}/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="number" name="discount" value="{{ old('discount',$studio->discount) }}"
                                       class="form-control"/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="number" name="audio_eng_rate_hr"
                                       value="{{ old('audio_eng_rate_hr',$studio->audio_eng_rate_hr) }}"
                                       class="form-control"/>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="audio_eng_discount_yes" name="audio_eng_discount"
                                           class="form-check-input"
                                           value="1" {{ (old('audio_eng_discount',$studio->audio_eng_discount) == '1') ? 'checked' : '' }}/>
                                    ...
                                    <input type="radio" id="audio_eng_discount_no" name="audio_eng_discount"
                                           class="form-check-input"
                                           value="0" {{ (old('audio_eng_discount',$studio->audio_eng_discount) == '0') ? 'checked' : ''  }}/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="number" name="other_fees"
                                       value="{{ old('other_fees',$studio->other_fees) }}"
                                       class="form-control"/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="number" name="mixing_services"
                                       value="{{ old('mixing_services',$studio->mixing_services) }}"
                                       class="form-control"/>
                            </div>
                            ...
                            <div class="col-md-4">
                                <select name="studio_types[]" class="form-control" multiple>
                                    @foreach($types as $key => $val)
                                        <option value="{{$val->id}}" {{  (in_array($val->id, (array)old("studio_types",$studio->getStudioTypes->pluck('type_id')->toArray())) ? "selected":"") }}>{{$val->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div>
                            @if(!empty($studio->getImages))
                                @foreach($studio->getImages as $key => $val)
                                    <img id="image" style="border: solid; margin: auto 10px;" src="{{$val->image_url}}" alt="{{$val->studio_id}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="street" value="{{ old('street',$studio->street) }}"
                                       class="form-control"/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="country" value="{{ old('country',$studio->country) }}"
                                       class="form-control"/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="state" value="{{ old('state',$studio->state) }}"
                                       class="form-control"/>
                            </div>
                            @if ($errors->has('state'))
                                <span class="help-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="zip_code" value="{{ old('zip_code',$studio->zip_code) }}"
                                       class="form-control"/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="lat" value="{{ old('lat',$studio->lat) }}"
                                       class="form-control"/>
                            </div>
                            @if ($errors->has('lat'))
                                <span class="help-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="lng" value="{{ old('lng',$studio->lng) }}"
                                       class="form-control"/>
                            </div>
                            @if ($errors->has('lng'))
                                <span class="help-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="additional_details" value="{{ old('additional_details',$studio->additional_details) }}"
                                       class="form-control"/>
                            </div>

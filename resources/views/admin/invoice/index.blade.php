...
@section('footer-js')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route("invoice.list.data") }}');
            ...
            appConfig.set('yajrabox.columns', [
                ...
                {data: 'studio_owner', orderable: false, searchable: false, className: 'text-center'},
                {data: 'request_user', orderable: false, searchable: false, className: 'text-center'},
                {data: 'studio', orderable: false, searchable: false, className: 'text-center'},
